...
import { DashboardMobileNav } from "@/shared/components/layouts/dashboard-mobile-nav";
import {
  SIDE_PANEL_WIDTH,
  SidePanelProvider,
  SidePanelSlot,
  SidePanelToggle,
  useSidePanelSlot,
} from "@/shared/components/layouts/dashboard-side-panel";
import { DashboardTopbar } from "@/shared/components/layouts/dashboard-topbar";
import {
  getLeagueIdFromPath,
  getShellScope,
