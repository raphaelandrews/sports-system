...
async def get_notifications(
    ...
    notifications, total = await notification_service.list_for_user(session, user_id, page, per_page)
    return PaginatedResponse(
...
@router.patch("/users/notifications/{notification_id}/read", response_model=NotificationResponse)
