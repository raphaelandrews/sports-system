...
from app.shared.core.deps import get_current_user, require_league_admin, require_league_chief, require_league_member
...
from app.features.athletes import service as athlete_service
