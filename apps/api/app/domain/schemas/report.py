...
from app.domain.schemas.athlete import AthleteResponse, DelegationHistoryItem, MatchHistoryItem
from app.domain.schemas.result import MedalBoardEntry, RecordResponse, ResultResponse
